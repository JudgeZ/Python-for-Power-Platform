...
def test_crud_cycle(respx_mock, token_getter):
    ...
    respx_mock.get("https://example.crm.dynamics.com/api/data/v9.2/accounts", params={"$select": "name"}).mock(
    ...
    respx_mock.post("https://example.crm.dynamics.com/api/data/v9.2/accounts").mock(
        return_value=httpx.Response(201, headers={"OData-EntityId": "https://example/.../accounts(12345)"})
    )
