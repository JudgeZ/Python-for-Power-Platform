...
def test_list_solutions(respx_mock, token_getter):
    ...
    respx_mock.get("https://example.crm.dynamics.com/api/data/v9.2/solutions").mock(
        return_value=httpx.Response(200, json={"value": [{"uniquename": "sol", "version": "1.0.0.0"}]})
    )
...
def test_export_import_publish(respx_mock, token_getter):
    ...
    respx_mock.post("https://example.crm.dynamics.com/api/data/v9.2/PublishAllXml").mock(return_value=httpx.Response(204))
    dv.publish_all()
