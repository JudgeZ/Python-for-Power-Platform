        ...
        *,
        ...
        def is_done(status: dict[str, Any]) -> bool:
            ...
            if not isinstance(current, str):
                return False
            return current in done_states

        def to_progress(status: dict[str, Any]) -> int | None:
            pct = status.get("percentComplete")
        ...
        return AsyncOperationStatus.model_validate(status)
